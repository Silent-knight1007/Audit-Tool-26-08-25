  ...
  return (
    <div className="min-h-screen flex justify-center items-start bg-white p-4 pt-24">
      <div className="w-full max-w-md mx-auto">
        <form
          className="bg-white border-2 border-red-800 p-8 rounded-2xl shadow-xl w-full animate-fade-in"
        ...
        >
          ...
          <div className="mb-3">
            <label className="block text-red-700 mb-1 font-bold" htmlFor="email">Email</label>
            <input
              id="email"
              type="email"
              autoComplete="off"
              className={`w-full px-4 py-2 rounded text-black font-bold border border-red-700 focus:outline-none focus:border-red-700 transition`}
              value={loginEmail}
          ...
          <button
            type="submit"
            className="w-full bg-red-700 text-lg hover:bg-red-500 text-black font-bold py-2 rounded transition">
            Sign In
          </button>
        </form>
      </div>
